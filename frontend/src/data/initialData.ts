...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    email: 'emily.watson@apexhealth.org',
    role: 'doctor',
    avatar: 'https://images.unsplash.com/photo-1594824813589-32bb44288000?auto=format&fit=crop&q=80&w=256',
...
export const INITIAL_PATIENTS: Patient[] = [
  {
    ...
    registered_by: 'Priya Sharma (Reception)',
  ...
  },
  {
    ...
    registered_by: 'Priya Sharma (Reception)',
    avatar_url: 'https://images.unsplash.com/photo-1519456264917-42d0aa2e0625?auto=format&fit=crop&q=80&w=256',
...
export const INITIAL_CASES: CaseRecord[] = [
  // Longitudinal Visit 1 for Alex Mercer
  {
    ...
    doctor_signature: 'Dr. Sarah Chen, MD (Cardiology & Internal Medicine)'
  },

  // Longitudinal Visit 2 for Alex Mercer (Current Visit - 25 Aug 2026)
  {
    case_id: 'CASE-2026-001-V2',
    patient_id: 'PAT-2026-0001',
    doctor_id: 'doc-01',
...
export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  {
    ...
    details: 'Completed and finalized follow-up clinical case sheet for Patient Alex Mercer (PAT-2026-0001)',
  ...
  },
  {
    ...
    details: 'Status advanced from Waiting to In Consultation for Dr. Sarah Chen',
  ...
  },
  {
    ...
    details: 'Registered Meera Deshmukh (Age 30, Female) with ID PAT-2026-0005',
    ip_address: '192.168.1.101',
  ...
  },
  {
    log_id: 'LOG-9917',
    user_id: 'doc-02',
    user_name: 'Dr. Rajesh Verma',
    user_role: 'Doctor',
    action: 'Ordered Lab Investigation',
    entity_type: 'Case',
    entity_id: 'CASE-2026-003-V1',
    details: 'Ordered MRI Brain + NCCT Cervical Spine for patient Vikramaditya Rao',
