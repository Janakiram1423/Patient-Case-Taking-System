...
export const StaffManagement: React.FC = () => {
  const { users, addUser } = useHospital();
  ...
  const handleAddUser = (e: React.FormEvent) => {
    ...
    addUser({
      ...
      status: 'Active',
      avatar: `https://images.unsplash.com/photo-${role === 'doctor' ? '1559839734-2b71ea197ec2' : '1573496359142-b8d87734a5a2'}?auto=format&fit=crop&q=80&w=256`
    });
