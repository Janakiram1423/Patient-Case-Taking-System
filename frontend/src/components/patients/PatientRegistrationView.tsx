      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-slate-200 p-5 sm:p-6 shadow-xs space-y-6">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
            ...
            <label className="font-bold text-slate-700">SpO₂<input value={spo2} onChange={event => setSpo2(event.target.value)} placeholder="%" className={fieldClass} /></label>
            <label className="font-bold text-slate-700">Height<input value={height} onChange={event => setHeight(event.target.value)} placeholder="cm" className={fieldClass} /></label>
            ...
            <label className="font-bold text-slate-700">Respiratory rate<input value={respiratoryRate} onChange={event => setRespiratoryRate(event.target.value)} placeholder="/min" className={fieldClass} /></label>
          </div>
        </section>
